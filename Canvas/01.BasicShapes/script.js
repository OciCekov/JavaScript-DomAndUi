...
(function () {
   ...
   var  ctx = canvas.getContext('2d');
    ...
    function drawEllipse(x, y, r, startAngle, endAngle, scaleX, scaleY) {
        ctx.save();
    ...
    function drawEye(x, y, r, startAngle, endAngle, scaleX, scaleY) {
        drawEllipse(x, y, r, startAngle, endAngle, scaleX, scaleY);
        ctx.moveTo(x * 1.5 + r / 2, y);
        ctx.save();

        ctx.beginPath();
        ctx.fillStyle = "#327a8c";
        drawEllipse(x * 1.5 - 2, y / 1.5, r / 2, startAngle, endAngle, scaleY, scaleX);
        ctx.restore();
    }
    ...
    function drawHat(x, y) {
        ...
        ctx.strokeStyle = "#000";
        ctx.lineWidth = 2;
        drawEllipse(x, y, 40, 0, 2 * Math.PI, 1.5, 0.3);

        ctx.beginPath();
        drawEllipse(x, (y - 130), 20, 0, 2 * Math.PI, 1.5, 0.5);
        ...
        drawEllipse(x, (y - 230), 20, 0, 2 * Math.PI, 1.5, 0.5);
    }
    ...
    function drawHead() {
        ...
        drawEllipse(120, 240, 15, 0, 2 * Math.PI, 1.5, 0.5);
        ctx.restore();
        ctx.moveTo(160, 130);
        ctx.lineTo(150, 130);
        ctx.lineTo(160, 110);
    ...
    function drawHouse() {
        ...
        ctx.stroke();
        ctx.beginPath();
        drawEllipse(650, 200, 10, 0, 2 * Math.PI, 1, 0.5);
